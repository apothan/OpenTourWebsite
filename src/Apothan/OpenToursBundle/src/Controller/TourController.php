...
use Apothan\OpenToursBundle\Entity\SellDateBreak;
use Apothan\OpenToursBundle\Entity\SellAmount;
use Apothan\OpenToursBundle\Form\Type\AddTourType;
use Apothan\OpenToursBundle\Form\Type\EditTourType;
use Apothan\OpenToursBundle\Form\Type\TourCategoriesType;
use Apothan\OpenToursBundle\Form\Type\TourSellsType;
use Apothan\OpenToursBundle\Form\Type\TourBreakAddType;
use Apothan\OpenToursBundle\Form\Type\TourFeaturesType;
use Apothan\OpenToursBundle\Form\Type\TourItineraryType;
...
class TourController extends AbstractController
{
    ...
    public function addTour()
    {
        ...
        return $this->render('@ApothanOpenTours/addtour.html.twig', [
