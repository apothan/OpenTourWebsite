...
use Apothan\OpenToursBundle\Repository\SellDateBreaksRepository;
...
class SellDateBreak
{
    ...
    /**
    * @var \Apothan\OpenToursBundle\Entity\Tour
    *
    * @ORM\ManyToOne(targetEntity="Apothan\OpenToursBundle\Entity\Tour", inversedBy="selldatebreaks")
    * @ORM\JoinColumns({
    ...
    */
    ...
    /**
      ...
      *
      * @ORM\OneToMany(targetEntity="Apothan\OpenToursBundle\Entity\SellAmount", mappedBy="selldatebreak", cascade={"persist","remove"})
      */
