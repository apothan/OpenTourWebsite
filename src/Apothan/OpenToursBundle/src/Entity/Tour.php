...
use Apothan\OpenToursBundle\Repository\TourRepository;
...
class Tour
{
    ...
    /**
      ...
      *
      * @ORM\OneToMany(targetEntity="Apothan\OpenToursBundle\Entity\TourCategory", mappedBy="tour", cascade={"persist","remove"})
      */
    ...
    /**
      * @var \Doctrine\Common\Collections\Collection
      *
      * @ORM\OneToMany(targetEntity="Apothan\OpenToursBundle\Entity\SellDateBreak", mappedBy="tour", cascade={"persist","remove"})
      */
    ...
    /**
      * @var \Doctrine\Common\Collections\Collection
      *
      * @ORM\OneToMany(targetEntity="Apothan\OpenToursBundle\Entity\TourItinerary", mappedBy="tour", cascade={"persist","remove"})
      */
    ...
    /**
      * @var \Doctrine\Common\Collections\Collection
      *
      * @ORM\OneToMany(targetEntity="Apothan\OpenToursBundle\Entity\TourFeature", mappedBy="tour", cascade={"persist","remove"})
      */
