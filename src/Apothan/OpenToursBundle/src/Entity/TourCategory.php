...
use Apothan\OpenToursBundle\Repository\TourCategoryRepository;
...
class TourCategory
{
    ...
    *
    * @ORM\ManyToOne(targetEntity="Apothan\OpenToursBundle\Entity\Tour", inversedBy="categories")
    * @ORM\JoinColumns({
    ...
    */
    ...
    /**
      ...
      *
      * @ORM\OneToMany(targetEntity="Apothan\OpenToursBundle\Entity\SellAmount", mappedBy="tourcategory")
      */
